...
return [
    ...
    "loading_top_up_data" => "Loading Top Up Data. Please wait.",
    "empty_top_up_title" => "No Top Up Transaction Found",
    "empty_top_up_caption" => "There are no top up transaction in the listing yet. Once user top up, you'll see their transactions here.",
    ...
    "lucky_star_admin" =>  "Lucky Star Admin",
