    ...
    <div class="bg-white dark:bg-gray-700 w-full xl:min-w-[540px] flex flex-col gap-6 md:gap-5 xl:gap-8 p-4 md:py-6 md:px-8 rounded-2xl shadow-toast self-stretch">
        <div class="flex flex-col pb-6 md:pb-5 xl:pb-8 items-start gap-4 self-stretch border-b border-gray-200 dark:border-gray-500">
            ...
            <div v-if="userDetail" class="flex flex-col items-start gap-1.5 self-stretch">
                <div class="flex items-center gap-3 self-stretch">
                    <div class="truncate text-gray-950 dark:text-white md:text-lg font-semibold">
                        {{ userDetail.name }}
                    </div>
            ...
            <div v-else class="animate-pulse flex flex-col items-start gap-1.5 self-stretch">
                <div class="h-4 bg-gray-200 dark:bg-gray-500 rounded-full w-48 my-2 md:my-3"></div>
                <div class="h-2 bg-gray-200 dark:bg-gray-500 rounded-full w-20 mb-1"></div>
            </div>
        </div>
        <div v-if="userDetail" class="flex flex-col justify-center items-center gap-5 self-stretch">
            <div class="flex justify-center items-center gap-5 self-stretch">
                <div class="flex flex-col justify-center items-start gap-2 w-1/2">
                    <div class="text-gray-500 dark:text-gray-300 text-xs w-full truncate">{{ $t('public.email_address') }}</div>
                    <div class="truncate text-gray-950 dark:text-white text-sm font-medium w-full">{{ userDetail.email }}</div>
                </div>
                <div class="flex flex-col justify-center items-start gap-2 w-1/2">
                    <div class="text-gray-500 dark:text-gray-300 text-xs w-full truncate">{{ $t('public.phone_number') }}</div>
                    <div class="truncate text-gray-950 dark:text-white text-sm font-medium w-full">{{ userDetail.dial_code }} {{ userDetail.phone }}</div>
                </div>
            </div>
            <div class="flex justify-center items-center gap-5 self-stretch">
                <div class="flex flex-col justify-center items-start gap-2 w-1/2">
                    <div class="text-gray-500 dark:text-gray-300 text-xs w-full truncate">{{ $t('public.country') }}</div>
                    <div class="truncate text-gray-950 dark:text-white text-sm font-medium w-full">{{ userDetail.country ?? '-' }}</div>
                </div>
                <div class="flex flex-col justify-center items-start gap-2 w-1/2">
                    <div class="text-gray-500 dark:text-gray-300 text-xs w-full truncate">{{ $t('public.nationality') }}</div>
                    <div class="truncate text-gray-950 dark:text-white text-sm font-medium w-full">{{ userDetail.nationality ?? '-' }}</div>
                </div>
            </div>
            <div class="flex justify-center items-center gap-5 self-stretch">
                <div class="flex flex-col justify-center items-start gap-2 w-1/2">
                    <div class="text-gray-500 dark:text-gray-300 text-xs w-full truncate">{{ $t('public.group') }}</div>
                    <div
            ...
            <div class="flex justify-center items-center gap-5 self-stretch">
                <div class="flex flex-col justify-center items-start gap-2 w-1/2">
                    <div class="text-gray-500 dark:text-gray-300 text-xs w-full truncate">{{ $t('public.total_referred_member') }}</div>
                    <div class="truncate text-gray-950 dark:text-white text-sm font-medium w-full">{{ userDetail.total_direct_member }}</div>
                </div>
                <div class="flex flex-col justify-center items-start gap-2 w-1/2">
                    <div class="text-gray-500 dark:text-gray-300 text-xs w-full truncate">{{ $t('public.total_referred_ib') }}</div>
                    <div class="truncate text-gray-950 dark:text-white text-sm font-medium w-full">{{ userDetail.total_direct_ib }}</div>
                </div>
            </div>
        </div>
        <div v-else class="flex flex-col justify-center items-center gap-5 self-stretch animate-pulse">
            <div class="flex justify-center items-center gap-5 self-stretch">
                <div class="flex flex-col justify-center items-start gap-2 w-1/2">
                    <div class="text-gray-500 dark:text-gray-300 text-xs w-full truncate">{{ $t('public.email_address') }}</div>
                    <div class="truncate text-gray-950 dark:text-white text-sm font-medium w-full">
                        <div class="h-2 bg-gray-200 dark:bg-gray-500 rounded-full w-48 my-2"></div>
                    </div>
                </div>
                <div class="flex flex-col justify-center items-start gap-2 w-1/2">
                    <div class="text-gray-500 dark:text-gray-300 text-xs w-full truncate">{{ $t('public.phone_number') }}</div>
                    <div class="h-2 bg-gray-200 dark:bg-gray-500 rounded-full w-36 my-2"></div>
                </div>
            </div>
            <div class="flex justify-center items-center gap-5 self-stretch">
                <div class="flex flex-col justify-center items-start gap-2 w-1/2">
                    <div class="text-gray-500 dark:text-gray-300 text-xs w-full truncate">{{ $t('public.group') }}</div>
                    <div class="h-3 bg-gray-200 dark:bg-gray-500 rounded-full w-20 mt-1 mb-1.5"></div>
                </div>
                <div class="flex flex-col justify-center items-start gap-2 w-1/2">
                    <div class="text-gray-500 dark:text-gray-300 text-xs w-full truncate">{{ $t('public.upline') }}</div>
                    <div class="h-3 bg-gray-200 dark:bg-gray-500 rounded-full w-36 mt-1 mb-1.5"></div>
                </div>
            </div>
            <div class="flex justify-center items-center gap-5 self-stretch">
                <div class="flex flex-col justify-center items-start gap-2 w-1/2">
                    <div class="text-gray-500 dark:text-gray-300 text-xs w-full truncate">{{ $t('public.total_referred_member') }}</div>
                    <div class="h-2 bg-gray-200 dark:bg-gray-500 rounded-full w-36 mt-2 mb-1"></div>
                </div>
                <div class="flex flex-col justify-center items-start gap-2 w-1/2">
                    <div class="text-gray-500 dark:text-gray-300 text-xs w-full truncate">{{ $t('public.total_referred_ib') }}</div>
                    <div class="h-2 bg-gray-200 dark:bg-gray-500 rounded-full w-36 mt-2 mb-1"></div>
                        ...
                        >
                            ...
                            <template #option="slotProps">
                                <div class="flex items-center w-[262px] md:max-w-[236px]">
                                    <div>{{ slotProps.option.name }} <span class="text-gray-500 dark:text-gray-300">{{ slotProps.option.phone_code }}</span></div>
                                </div>
                            </template>
                        </Select>
